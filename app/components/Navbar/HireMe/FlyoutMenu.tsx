...
import {
  getConnectPopoverState,
  setConnectPopoverState,
  toggleConnectPopoverState,
} from "@/app/functions/toggleConnectPopover";
...
export default function FlyoutMenu() {
  ...
  return (
    <Popover className={`relative hire-me mt-10 mr-20`}>
      {({ open }) => {
        useEffect(() => {
          setConnectPopoverState(open);
        }, [open]);

        return (
          <>
            <Popover.Button
              onClick={toggleConnectPopoverState}
